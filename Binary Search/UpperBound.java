...
public class UpperBound {
    ...
    // Time: O(N) | Space: O(1)
    // ===================================================
    public static int upperBoundBrute(int[] arr, int target) {
    ...
    public static void main(String[] args) {
        int[] arr = {1, 2, 2, 3, 3, 5};
        System.out.println(upperBound(arr, 2));  // Output: 3  (first index > 2 is arr[3]=3)
        System.out.println(upperBound(arr, 3));  // Output: 5  (arr[5]=5 > 3)
        System.out.println(upperBound(arr, 5));  // Output: 6  (not found)
    }
}
